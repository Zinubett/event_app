                      ...
                      (optionIndex) => GestureDetector(
                            ...
                            setState(() {
                              ...
                              if (widget.index == 0 &&
                                  ...
                                  (sampleQuestions.contains(
                                              addQuestions[widget.index]) ==
                                          false ||
                                      sampleQuestions
                                              .contains(addQuestions[3]) ==
                                          false)) {
                                sampleQuestions.add(addQuestions[widget.index]);
                                sampleQuestions.add(addQuestions[3]);
                              } else if (widget.index == 3 &&
                                  optionIndex == 0 &&
                                  sampleQuestions.contains(addQuestions[1]) ==
                                      false) {
                                sampleQuestions.add(addQuestions[1]);
                              } else if (widget.index == 0 &&
                                  (optionIndex == 0) &&
                                  sampleQuestions.contains(addQuestions[4]) ==
                                      false) {
                          ...
                          child: Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  border: Border.all(
                                      width: 1,
                                      color: sampleQuestions[widget.index]
                                                  .answer ==
                                              sampleQuestions[widget.index]
                                                  .options[optionIndex]
                                          ? borderActiveColor
